...
class Config(object):
    API_ID = int(os.environ.get("API_ID", "26548330"))
    ...
    DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://FLAMEXMASTER1:FLAMEXMASTER1@cluster0.gsbo8hg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    OWNER_ID = int(os.environ.get("OWNER_ID", "6890753169"))
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002823882872"))
